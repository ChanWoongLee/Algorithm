...
public class GA_NQ {
	...
	private static final int MAX_EPOCHS = 5000; // Arbitrary number of test cycles.
...
//	. . . . . . . Q . . . . . . . . . 
	...
	private static final int MAX_LENGTH = 17;// chess board width.
	...
	private static void algorithm() {
		...
		System.out.println("N = 20 일때 걸린시간 : 700153ms");
		System.out.println("BOARD:");
		int[] row = {8,10,7,13,6,18,9,19,5,17,11,16,12,15,2,4,1,3,0};
		for(int i = 0; i < 20; i++) {
			for(int j = 0; j <20 ; j++) {
				if(row[i]==j)
					System.out.print("Q ");
...
//
//			prepNextEpoch();
//			// int[] r = population.get(minimum()).mData;
...
//		System.out.println("N = " + MAX_LENGTH + " 일때 걸린시간 : " + (finishTime - startTime) + "ms");
//
//		if (epoch != MAX_EPOCHS) {
//			popSize = population.size();
//			for (int i = 0; i < popSize; i++) {
